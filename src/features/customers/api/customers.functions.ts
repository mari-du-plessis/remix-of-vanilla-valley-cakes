...
export const listCustomers = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }): Promise<Customer[]> =>
    fetchCustomers(context.supabase, data),
  );
...
export const updateCustomer = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    updateCustomerRow(context.supabase, data.id, data.values),
  );
...
export const updateCustomerAddress = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    updateAddressRow(context.supabase, data.id, data.values),
  );
...
export const deleteCustomerAddress = createServerFn({ method: "POST" })
  ...
  .inputValidator((data: unknown) => idSchema.parse(data))
  .handler(async ({ data, context }) =>
    deleteRow(context.supabase, "customer_addresses", data.id),
  );
...
export const createCustomerNote = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    insertNote(context.supabase, data.customerId, data.body),
  );
...
export const deleteCustomerNote = createServerFn({ method: "POST" })
  ...
  .inputValidator((data: unknown) => idSchema.parse(data))
  .handler(async ({ data, context }) =>
    deleteRow(context.supabase, "customer_notes", data.id),
  );
