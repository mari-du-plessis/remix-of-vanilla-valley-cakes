...
export function CakeStage({
  ...
  return (
    <div
      className={cn("surface-card overflow-hidden rounded-3xl border border-border/60", className)}
    >
      ...
      {caption && <p className="px-5 pt-2 text-center text-sm text-foreground/80">{caption}</p>}
      ...
      {showDisclaimer && (
        <p className="px-5 pb-4 pt-2 text-center text-[11px] leading-relaxed text-muted-foreground">
          ...
          decorations and handcrafted details may vary slightly. You can still upload inspiration
          photos and include additional notes to help us understand your vision.
        </p>
      )}
