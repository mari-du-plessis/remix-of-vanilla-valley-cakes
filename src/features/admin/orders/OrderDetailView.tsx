      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <Section title="Cake details">
            ...
            {(order.inspirationUrl || order.aiPreviewUrl) && (
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {order.aiPreviewUrl && (
                  <figure className="space-y-1">
                    <img
                      src={order.aiPreviewUrl}
                      alt="AI inspiration preview generated by the customer"
                ...
                {order.inspirationUrl && (
                  <figure className="space-y-1">
                    <img
                      ...
                      alt="Inspiration photo uploaded by the customer"
                      className="w-full rounded-2xl border border-border/60 object-cover"
                      loading="lazy"
                    />
                    <figcaption>
                      ...
                      >
                        Uploaded inspiration photo <ExternalLink className="h-3 w-3" />
                      </a>
                    </figcaption>
                  </figure>
                )}
